...
if ($result_recent_activity && $result_recent_activity->num_rows > 0) {
    while ($row = $result_recent_activity->fetch_assoc()) {
        ...
        $activity = [
            ...
            'date' => date('Y-m-d H:i', strtotime($row['created_at'])) // Format the timestamp
        ];
...
<body class="bg-light">
    ...
    <div class="container my-5 p-4 bg-white rounded-3 shadow">
        <h2 class="text-center mb-4 text-primary">Admin Management</h2>

        <div class="d-flex flex-wrap justify-content-center gap-3 mb-5">
            <a href="categoryAll.php" class="btn btn-outline-primary btn-lg rounded-pill shadow-sm flex-grow-1 flex-md-grow-0">
                <i class="fas fa-list-alt me-2"></i>Manage Categories
            </a>
            <a href="authorAll.php" class="btn btn-outline-success btn-lg rounded-pill shadow-sm flex-grow-1 flex-md-grow-0">
                <i class="fas fa-user-tie me-2"></i>Manage Authors
            </a>
            <a href="bookAll.php" class="btn btn-outline-info btn-lg rounded-pill shadow-sm flex-grow-1 flex-md-grow-0">
                <i class="fas fa-book me-2"></i>Manage Books
            </a>
            <a href="userAll.php" class="btn btn-outline-danger btn-lg rounded-pill shadow-sm flex-grow-1 flex-md-grow-0">
    ...
    <footer class="footer bg-dark text-white-50 py-3 mt-5">
