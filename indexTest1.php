      ...
      <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="_admins/photos/bookLight.jpg" class="d-block w-100" alt="Banner 2">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="_admins/photos/robot.png" class="d-block w-100" alt="Banner 2">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-4">
          <div class="card h-100 shadow-sm d-flex flex-column">
            ...
            <div class="card-body d-flex flex-column justify-content-center">
              ...
              <a href="bookDetail.php?id=<?= $book->id ?>" class="btn btn-outline-primary mt-3" style="width: 115px;">View Details</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
